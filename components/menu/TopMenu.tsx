...
export const TopMenu = ({ lit = false, onToggleClick = () => { }, className = "" }: TopMenuProps) => {
    ...
    return <div className="">
        <div className={`${lit ? "rounded-tl-lg rounded-tr-lg" : "rounded-lg border-b"} w-fit pointer-events-auto relative text-base-content shadow-lg border-accent border-l border-t border-r bg-background flex`}>
